...
# Clone your fork
git clone git@github.com:<your-username>/prismic-upgrade-from-legacy.git
...
## `@prismicio/upgrade-from-legacy` in Prismic's Open-Source Ecosystem
...
[repo-issue]: https://github.com/prismicio/prismic-upgrade-from-legacy/issues/new/choose
