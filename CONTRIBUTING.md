...
# Clone your fork
git clone git@github.com:<your-username>/prismic-upgrade.git
...
## `@prismicio/upgrade` in Prismic's Open-Source Ecosystem
...
[repo-issue]: https://github.com/prismicio/prismic-upgrade/issues/new/choose
